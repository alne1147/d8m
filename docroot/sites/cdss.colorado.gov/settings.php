...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/coloradod8m/cdss-settings.inc';
}
...
$config_directories['sole'] = '../config/cdss.colorado.gov/sole';
...
$config['acquia_search.settings']['connection_override'] = [
    ...
    'index_id' => 'CDIY-145117.dev.cdsscoloradogov',
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_coloradod8m_dev_cdss_colorado_gov.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_coloradod8m_dev_cdss_colorado_gov.inc';
}
// </DDSETTINGS>
