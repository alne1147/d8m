...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/coloradod8m/dora-settings.inc';
}
...
$config_directories['sole'] = '../config/dora.colorado.gov/sole';
$settings['install_profile'] = 'ci_start';
$config['content_directory'] = '../content';
$conf['file_temporary_path'] = 'tmp';
$config['system.site']['name'] = 'Department of Regulatory Agencies';
// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tags.
// This section is autogenerated by Acquia Dev Desktop.
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_coloradod8m_dev_dora_colorado_gov.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_coloradod8m_dev_dora_colorado_gov.inc';
}
// </DDSETTINGS>
