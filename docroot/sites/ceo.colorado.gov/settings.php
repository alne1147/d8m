...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/coloradod8m/ceo-settings.inc';
}
...
$config_directories['sole'] = '../config/ceo.colorado.gov/sole';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_coloradod8m_dev_ceo_colorado_gov.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_coloradod8m_dev_ceo_colorado_gov.inc';
}
// </DDSETTINGS>
