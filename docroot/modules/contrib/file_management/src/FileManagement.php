...
class FileManagement implements FileManagementInterface {
  ...
  /**
   * Adds a back button with the provided text if the destination query
   * parameter was set.
   *
   * @param array $form
   ...
   */
  public static function addBackButton(&$form, $text) {
   ...
   * valid over all different field configurations.
   *
   * @param \Drupal\file\FileInterface $file
