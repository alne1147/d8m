...
/**
 * @file
 * Contains Drupal\menu_condition\Plugin\Condition\MenuPosition.
 */
...
class MenuPosition extends ConditionPluginBase implements ConditionInterface, ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['menu_parent']['#options'] = array('' => t("- None -")) + $form['menu_parent']['#options'];
  ...
  public function defaultConfiguration() {
    return array('menu_parent' => '') + parent::defaultConfiguration();
  }
